...
namespace Oleg {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class StreetDataTable : global::System.Data.TypedTableBase<StreetRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StreetRow FindByКод(int Код) {
        ...
        public partial class StreetRow : global::System.Data.DataRow {
            ...
            public int Код {
                get {
                    return ((int)(this[this.tableStreet.КодColumn]));
                }
                set {
                    this[this.tableStreet.КодColumn] = value;
                }
            }
...
namespace Oleg.Database1DataSetTableAdapters {
    ...
    public partial class StreetTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Street` WHERE ((`Код` = ?) AND ((? = 1 AND `Street` IS NULL) OR (`St" +
                "reet` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Street` (`Street`) VALUES (?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Street` SET `Street` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `Street` IS N" +
                "ULL) OR (`Street` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Oleg.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, Street FROM Street";
        ...
        public virtual int Fill(Database1DataSet.StreetDataTable dataTable) {
        ...
        public virtual Database1DataSet.StreetDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.StreetDataTable dataTable = new Database1DataSet.StreetDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.StreetDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Код, string Original_Street) {
        ...
        public virtual int Update(string Street, int Original_Код, string Original_Street) {
            if ((Street == null)) {
